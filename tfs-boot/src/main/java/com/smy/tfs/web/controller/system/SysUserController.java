...
import com.smy.tfs.system.service.ISysPostService;
...
public class SysUserController extends BaseController {
    ...
    @GetMapping("/allSystemUserList")
    public AjaxResult allSystemUserList() {
        List<SysUser> list = userService.allSystemUserList();
