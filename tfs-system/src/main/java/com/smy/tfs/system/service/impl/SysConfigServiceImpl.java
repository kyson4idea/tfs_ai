...
import com.smy.tfs.common.annotation.DataSource;
...
import com.smy.tfs.system.domain.SysConfig;
import com.smy.tfs.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService {
     ...
     */
    @Override
    public boolean selectLdapLoginEnabled() {
        String ldapLoginEnabled = selectConfigByKey("sys.account.ldapLoginEnabled");
        if (StringUtils.isEmpty(ldapLoginEnabled)) {
            return false;
        }
        return Convert.toBool(ldapLoginEnabled);
    }
