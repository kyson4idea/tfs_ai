...
@Data
public class OwnQueryRspDto implements Serializable {
    private static final long serialVersionUID = -358414650628928879L;
    ...
    public OwnQueryRspDto(Map<String,Object> map){
        String appName = "";
