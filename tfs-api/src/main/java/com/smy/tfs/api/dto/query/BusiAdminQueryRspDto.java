...
@Data
public class BusiAdminQueryRspDto implements Serializable {
    private static final long serialVersionUID = -2837619602161061397L;
    ...
    public BusiAdminQueryRspDto(Map<String,Object> map){
        String appName = "";
